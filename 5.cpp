...
5) Ídem anterior utilizando pasaje por valor para el primer miembro y pasaje por
referencia para el segundo.
 */
...
int main() {
	...
	int menor ;
	leernumeros(&n);
	menor=menornumero(n.valor1 , &n.valor2); // valor1=valor valor2=referencia 
